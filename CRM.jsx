...
function Logo({ compact }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
      <div style={{ display: "flex", fontFamily: "'Oswald', sans-serif", fontWeight: 700, fontSize: compact ? 20 : 26, letterSpacing: 0.5, lineHeight: 1 }}>
      ...
      {!compact && (
        <span style={{ fontFamily: "'Inter', sans-serif", fontSize: 10, letterSpacing: 1.5, color: "#9A9A9A", fontWeight: 600, textTransform: "uppercase", borderLeft: "1px solid #E7E5E2", paddingLeft: 10 }}>
          Certyfikowani Doradcy<br />Motoryzacyjni
        </span>
      )}
    </div>
  );
